...
async function main() {
  ...
  const disclaimer   = `\n\n*This analysis is generated automatically from ${company.name}'s publicly available Terms of Service and/or Privacy Policy. It may contain inaccuracies. If you spot an error, [let us know](/contact).*`;
