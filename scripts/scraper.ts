...
const COMPANIES: Company[] = [
  ...
  { name: 'New Relic',         sector: 'Dev Tools',      logo_color: '#008C99', tos_url: 'https://newrelic.com/termsandconditions/terms' },
  ...
  { name: 'Wise',              sector: 'Fintech',        logo_color: '#00B9FF', tos_url: 'https://wise.com/us/legal/terms-of-use-us2' },
