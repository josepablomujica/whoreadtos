                ...
                {selectedCompanies.map(company => (
                  <div key={company.id} className="border border-gray-200 rounded-2xl p-5 relative">
                    <button
                      ...
                      className="absolute top-5 right-3 text-gray-400 hover:text-gray-900 hover:bg-gray-100 transition-colors text-2xl leading-none w-7 h-7 flex items-center justify-center rounded-full"
